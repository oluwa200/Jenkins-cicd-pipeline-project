...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.26.178:9000 \
                -Dsonar.login=db5c9f11a094b84008ec361ecd0330ecd3eb15bc
  ...
  post {
    always {
        ...
        slackSend channel: '#jean-moise-cicd-pipeline-alerts', //update and provide your channel name
